...
config['device'] = 'cpu'
config['path_to_restore'] = 'conversion/im_4d_w_obs_attitude_smallobs_4000_epoch_32trajs_w_safegil/[256,256]_tanh' # 'conversion/[16,16,16]_tanh'
...
generate_c_model(model, "im_4d_w_obs_attitude_smallobs_4000_epoch_32trajs_w_safegil_[256,256]_tanh.c", "c_models/", testing=False)
